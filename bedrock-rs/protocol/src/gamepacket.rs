...
impl GamePacket {
    pub fn pk_serilize(&self, buf: &mut Vec<u8>) -> Result<(), SerilizationError> {
        match self {
            GamePacket::Login(pk) => { ser_packet!(buf, GamePacketID::LoginID, pk) }
            GamePacket::PlayStatus() => { unimplemented!() }
            GamePacket::ServerToClientHandshake(pk) => { ser_packet!(buf, GamePacketID::ServerToClientHandshakeID, pk) }
            ...
            GamePacket::NetworkSettings(pk) => { ser_packet!(buf, GamePacketID::NetworkSettingsID, pk) }
            ...
            GamePacket::RequestNetworkSettings(pk) => { ser_packet!(buf, GamePacketID::RequestNetworkSettingsID, pk) }
    ...
    pub fn pk_deserialize(cursor: &mut Cursor<Vec<u8>>) -> Result<GamePacket, DeserilizationError> {
        ...
        match gamepacket_id {
            ...
            GamePacketID::ResourcePackStackID => { unimplemented!() }
            GamePacketID::ResourcePackClientResponseID => { unimplemented!() }
            GamePacketID::TextID => { unimplemented!() }
            GamePacketID::SetTimeID => { unimplemented!() }
            GamePacketID::StartGameID => { unimplemented!() }
            GamePacketID::AddPlayerID => { unimplemented!() }
            GamePacketID::AddEntityID => { unimplemented!() }
            GamePacketID::RemoveEntityID => { unimplemented!() }
            GamePacketID::AddItemEntityID => { unimplemented!() }
            GamePacketID::TakeItemEntityID => { unimplemented!() }
            GamePacketID::MoveEntityID => { unimplemented!() }
            GamePacketID::MovePlayerID => { unimplemented!() }
            GamePacketID::RiderJumpID => { unimplemented!() }
            GamePacketID::UpdateBlockID => { unimplemented!() }
            GamePacketID::AddPaintingID => { unimplemented!() }
            GamePacketID::TickSyncID => { unimplemented!() }
            GamePacketID::LevelSoundEventOldID => { unimplemented!() }
            GamePacketID::LevelEventID => { unimplemented!() }
            GamePacketID::BlockEventID => { unimplemented!() }
            GamePacketID::EntityEventID => { unimplemented!() }
            GamePacketID::MobEffectID => { unimplemented!() }
            GamePacketID::UpdateAttributesID => { unimplemented!() }
            GamePacketID::InventoryTransactionID => { unimplemented!() }
            GamePacketID::MobEquipmentID => { unimplemented!() }
            GamePacketID::MobArmorEquipmentID => { unimplemented!() }
            GamePacketID::InteractID => { unimplemented!() }
            GamePacketID::BlockPickRequestID => { unimplemented!() }
            GamePacketID::EntityPickRequestID => { unimplemented!() }
            GamePacketID::PlayerActionID => { unimplemented!() }
            GamePacketID::HurtArmorID => { unimplemented!() }
            GamePacketID::SetEntityDataID => { unimplemented!() }
            GamePacketID::SetEntityMotionID => { unimplemented!() }
            GamePacketID::SetEntityLinkID => { unimplemented!() }
            GamePacketID::SetHealthID => { unimplemented!() }
            GamePacketID::SetSpawnPositionID => { unimplemented!() }
            GamePacketID::AnimateID => { unimplemented!() }
            GamePacketID::RespawnID => { unimplemented!() }
            GamePacketID::ContainerOpenID => { unimplemented!() }
            GamePacketID::ContainerCloseID => { unimplemented!() }
            GamePacketID::PlayerHotbarID => { unimplemented!() }
            GamePacketID::InventoryContentID => { unimplemented!() }
            GamePacketID::InventorySlotID => { unimplemented!() }
            GamePacketID::ContainerSetDataID => { unimplemented!() }
            GamePacketID::CraftingDataID => { unimplemented!() }
            GamePacketID::CraftingEventID => { unimplemented!() }
            GamePacketID::GuiDataPickItemID => { unimplemented!() }
            GamePacketID::AdventureSettingsID => { unimplemented!() }
            GamePacketID::BlockEntityDataID => { unimplemented!() }
            GamePacketID::PlayerInputID => { unimplemented!() }
            GamePacketID::LevelChunkID => { unimplemented!() }
            GamePacketID::SetCommandsEnabledID => { unimplemented!() }
            GamePacketID::SetDifficultyID => { unimplemented!() }
            GamePacketID::ChangeDimensionID => { unimplemented!() }
            GamePacketID::SetPlayerGameTypeID => { unimplemented!() }
            GamePacketID::PlayerListID => { unimplemented!() }
            GamePacketID::SimpleEventID => { unimplemented!() }
            GamePacketID::TelemetryEventID => { unimplemented!() }
            GamePacketID::SpawnExperienceOrbID => { unimplemented!() }
            GamePacketID::ClientboundMapItemDataID => { unimplemented!() }
            GamePacketID::MapInfoRequestID => { unimplemented!() }
            GamePacketID::RequestChunkRadiusID => { unimplemented!() }
            GamePacketID::ChunkRadiusUpdateID => { unimplemented!() }
            GamePacketID::ItemFrameDropItemID => { unimplemented!() }
            GamePacketID::GameRulesChangedID => { unimplemented!() }
            GamePacketID::CameraID => { unimplemented!() }
            GamePacketID::BossEventID => { unimplemented!() }
            GamePacketID::ShowCreditsID => { unimplemented!() }
            GamePacketID::AvailableCommandsID => { unimplemented!() }
            GamePacketID::CommandRequestID => { unimplemented!() }
            GamePacketID::CommandBlockUpdateID => { unimplemented!() }
            GamePacketID::CommandOutputID => { unimplemented!() }
            GamePacketID::UpdateTradeID => { unimplemented!() }
            GamePacketID::UpdateEquipmentID => { unimplemented!() }
            GamePacketID::ResourcePackDataInfoID => { unimplemented!() }
            GamePacketID::ResourcePackChunkDataID => { unimplemented!() }
            GamePacketID::ResourcePackChunkRequestID => { unimplemented!() }
            GamePacketID::TransferID => { unimplemented!() }
            GamePacketID::PlaySoundID => { unimplemented!() }
            GamePacketID::StopSoundID => { unimplemented!() }
            GamePacketID::SetTitleID => { unimplemented!() }
            GamePacketID::AddBehaviorTreeID => { unimplemented!() }
            GamePacketID::StructureBlockUpdateID => { unimplemented!() }
            GamePacketID::ShowStoreOfferID => { unimplemented!() }
            GamePacketID::PurchaseReceiptID => { unimplemented!() }
            GamePacketID::PlayerSkinID => { unimplemented!() }
            GamePacketID::SubClientLoginID => { unimplemented!() }
            GamePacketID::InitiateWebSocketConnectionID => { unimplemented!() }
            GamePacketID::SetLastHurtByID => { unimplemented!() }
            GamePacketID::BookEditID => { unimplemented!() }
            GamePacketID::NpcRequestID => { unimplemented!() }
            GamePacketID::PhotoTransferID => { unimplemented!() }
            GamePacketID::ModalFormRequestID => { unimplemented!() }
            GamePacketID::ModalFormResponseID => { unimplemented!() }
            GamePacketID::ServerSettingsRequestID => { unimplemented!() }
            GamePacketID::ServerSettingsResponseID => { unimplemented!() }
            GamePacketID::ShowProfileID => { unimplemented!() }
            GamePacketID::SetDefaultGameTypeID => { unimplemented!() }
            GamePacketID::RemoveObjectiveID => { unimplemented!() }
            GamePacketID::SetDisplayObjectiveID => { unimplemented!() }
            GamePacketID::SetScoreID => { unimplemented!() }
            GamePacketID::LabTableID => { unimplemented!() }
            GamePacketID::UpdateBlockSyncedID => { unimplemented!() }
            GamePacketID::MoveEntityDeltaID => { unimplemented!() }
            GamePacketID::SetScoreboardIdentityID => { unimplemented!() }
            GamePacketID::SetLocalPlayerAsInitializedID => { unimplemented!() }
            GamePacketID::UpdateSoftEnumID => { unimplemented!() }
            GamePacketID::NetworkStackLatencyID => { unimplemented!() }
            GamePacketID::ScriptCustomEventID => { unimplemented!() }
            GamePacketID::SpawnParticleEffectID => { unimplemented!() }
            GamePacketID::AvailableEntityIdentifiersID => { unimplemented!() }
            GamePacketID::LevelSoundEventV2ID => { unimplemented!() }
            GamePacketID::NetworkChunkPublisherUpdateID => { unimplemented!() }
            GamePacketID::BiomeDefinitionListID => { unimplemented!() }
            GamePacketID::LevelSoundEventID => { unimplemented!() }
            GamePacketID::LevelEventGenericID => { unimplemented!() }
            GamePacketID::LecternUpdateID => { unimplemented!() }
            GamePacketID::VideoStreamConnectID => { unimplemented!() }
            GamePacketID::ClientCacheStatusID => { unimplemented!() }
            GamePacketID::OnScreenTextureAnimationID => { unimplemented!() }
            GamePacketID::MapCreateLockedCopyID => { unimplemented!() }
            GamePacketID::StructureTemplateDataExportRequestID => { unimplemented!() }
            GamePacketID::StructureTemplateDataExportResponseID => { unimplemented!() }
            ...
            GamePacketID::ItemStackRequestID => { unimplemented!() }
            GamePacketID::ItemStackResponseID => { unimplemented!() }
            GamePacketID::UpdatePlayerGameTypeID => { unimplemented!() }
            GamePacketID::PacketViolationWarningID => { unimplemented!() }
            GamePacketID::ItemComponentID => { unimplemented!() }
            GamePacketID::FilterTextPacketID => { unimplemented!() }
            GamePacketID::UpdateSubChunkBlocksPacketID => { unimplemented!() }
