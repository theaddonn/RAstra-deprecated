...
impl Reliability {
    ...
    pub fn from(flags: u8) -> RaknetResult<Self> {
        match flags {
...
impl FrameSetPacket {
    ...
    pub fn _deserialize(buf: Vec<u8>) -> RaknetResult<(Self, bool)> {
    ...
    pub fn serialize(&self) -> RaknetResult<Vec<u8>> {
    ...
    pub fn is_reliable(&self) -> RaknetResult<bool> {
    ...
    pub fn is_ordered(&self) -> RaknetResult<bool> {
        let r = Reliability::from((self.flags & 224) >> 5)?;
        Ok(matches!(
            r,
    ...
    pub fn is_sequenced(&self) -> RaknetResult<bool> {
        let r = Reliability::from((self.flags & 224) >> 5)?;
        Ok(matches!(
            r,
    ...
    pub fn reliability(&self) -> RaknetResult<Reliability> {
        Reliability::from((self.flags & 224) >> 5)
    }

    pub fn _size(&self) -> RaknetResult<usize> {
        let mut ret = 0;
        // id
        ret += 1;
        // sequence number
...
impl FrameVec {
    pub fn new(buf: Vec<u8>) -> RaknetResult<Self> {
        let mut ret = Self {
            id: 0,
            sequence_number: 0,
            frames: vec![],
    ...
    pub fn _serialize(&self) -> RaknetResult<Vec<u8>> {
        let mut writer = RaknetWriter::new();
...
impl RecvQ {
    ...
    pub fn insert(&mut self, frame: FrameSetPacket) -> RaknetResult<()> {
...
impl SendQ {
    ...
    pub fn insert(&mut self, reliability: Reliability, buf: &[u8]) -> RaknetResult<()> {
        match reliability {
            Reliability::Unreliable => {
