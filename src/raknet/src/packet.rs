...
impl PacketID {
    ...
    pub fn from(id: u8) -> RaknetResult<Self> {
...
pub fn read_packet_ping(buf: &[u8]) -> RaknetResult<PacketUnconnectedPing> {
...
pub fn write_packet_ping(packet: &PacketUnconnectedPing) -> RaknetResult<Vec<u8>> {
...
pub fn read_packet_pong(buf: &[u8]) -> RaknetResult<PacketUnconnectedPong> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn write_packet_pong(packet: &PacketUnconnectedPong) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn read_packet_connection_open_request_1(buf: &[u8]) -> RaknetResult<OpenConnectionRequest1> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_connection_open_request_2(buf: &[u8]) -> RaknetResult<OpenConnectionRequest2> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_connection_open_reply_1(buf: &[u8]) -> RaknetResult<OpenConnectionReply1> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_connection_open_reply_2(buf: &[u8]) -> RaknetResult<OpenConnectionReply2> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn _read_packet_already_connected(buf: &[u8]) -> RaknetResult<AlreadyConnected> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
    Ok(AlreadyConnected {
        magic: unwrap_or_return!(cursor.read_magic()),
...
pub fn write_packet_already_connected(packet: &AlreadyConnected) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn read_packet_incompatible_protocol_version(
    buf: &[u8],
) -> RaknetResult<IncompatibleProtocolVersion> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_nack(buf: &[u8]) -> RaknetResult<Nack> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn write_packet_nack(packet: &Nack) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn read_packet_ack(buf: &[u8]) -> RaknetResult<Ack> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
    let record_count = unwrap_or_return!(cursor.read_u16(Endian::Big));
    let sequences = {
...
pub fn write_packet_ack(packet: &Ack) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn read_packet_connection_request(buf: &[u8]) -> RaknetResult<ConnectionRequest> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn write_packet_connection_request(packet: &ConnectionRequest) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn read_packet_connection_request_accepted(
    buf: &[u8],
) -> RaknetResult<ConnectionRequestAccepted> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_new_incomming_connection(buf: &[u8]) -> RaknetResult<NewIncomingConnection> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
...
pub fn read_packet_connected_ping(buf: &[u8]) -> RaknetResult<ConnectedPing> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
    Ok(ConnectedPing {
...
pub fn write_packet_connected_ping(packet: &ConnectedPing) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
...
pub fn _read_packet_connected_pong(buf: &[u8]) -> RaknetResult<ConnectedPong> {
    let mut cursor = RaknetReader::new(buf.to_vec());
    unwrap_or_return!(cursor.read_u8());
    Ok(ConnectedPong {
        client_timestamp: unwrap_or_return!(cursor.read_i64(Endian::Big)),
...
pub fn write_packet_connected_pong(packet: &ConnectedPong) -> RaknetResult<Vec<u8>> {
    let mut cursor = RaknetWriter::new();
