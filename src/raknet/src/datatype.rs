...
impl RaknetWriter {
    ...
    pub fn write(&mut self, v: &[u8]) -> RaknetResult<()> {
        self.buf.put_slice(v);
        Ok(())
    }

    pub fn write_u8(&mut self, v: u8) -> RaknetResult<()> {
        self.buf.put_u8(v);
        Ok(())
    }

    pub fn write_i16(&mut self, v: i16, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_i16(v);
                Ok(())
    ...
    pub fn write_u16(&mut self, v: u16, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_u16(v);
                Ok(())
    ...
    pub fn write_u24(&mut self, v: u32, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                let a = v.to_be_bytes();
                self.buf.put_u8(a[1]);
    ...
    pub fn write_u32(&mut self, v: u32, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_u32(v);
                Ok(())
    ...
    pub fn write_i32(&mut self, v: i32, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_i32(v);
                Ok(())
    ...
    pub fn write_i64(&mut self, v: i64, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_i64(v);
                Ok(())
    ...
    pub fn write_magic(&mut self) -> RaknetResult<usize> {
        let magic: [u8; 16] = [
    ...
    pub fn write_u64(&mut self, v: u64, n: Endian) -> RaknetResult<()> {
        match n {
            Endian::Big => {
                self.buf.put_u64(v);
                Ok(())
    ...
    pub fn write_string(&mut self, body: &str) -> RaknetResult<()> {
    ...
    pub fn write_address(&mut self, address: SocketAddr) -> RaknetResult<()> {
        if address.is_ipv4() {
            self.write_u8(0x4)?;
...
impl RaknetReader {
    ...
    pub fn read(&mut self, buf: &mut [u8]) -> RaknetResult<()> {
        match self.buf.read_exact(buf) {
            Ok(p) => Ok(p),
            Err(_) => Err(RaknetError::ReadPacketBufferError),
        }
    }
    pub fn read_u8(&mut self) -> RaknetResult<u8> {
        Ok(self.buf.get_u8())
    }

    pub fn read_u16(&mut self, n: Endian) -> RaknetResult<u16> {
    ...
    pub fn read_u24(&mut self, n: Endian) -> RaknetResult<u32> {
    ...
    pub fn read_u32(&mut self, n: Endian) -> RaknetResult<u32> {
    ...
    pub fn read_u64(&mut self, n: Endian) -> RaknetResult<u64> {
    ...
    pub fn read_i64(&mut self, n: Endian) -> RaknetResult<i64> {
        if self.buf.remaining() < 8 {
            return Err(RaknetError::ReadPacketBufferError);
        }
    ...
    pub fn read_string(&mut self) -> RaknetResult<String> {
        if self.buf.remaining() < 2 {
            return Err(RaknetError::ReadPacketBufferError);
        }
    ...
    pub fn read_magic(&mut self) -> RaknetResult<bool> {
    ...
    pub fn read_address(&mut self) -> RaknetResult<SocketAddr> {
